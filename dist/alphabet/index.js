...
function fillAnswers(count, correct) {
  ...
  while (answers.length < count) {
    var answer = charactersInfo[Math.floor(Math.random() * charactersInfo.length)];
...
function rndQuestion() {
  var $q = $('.alphabet-test-question');
  var answerButtons = [$('.alphabet-test-answer-1'), $('.alphabet-test-answer-2'), $('.alphabet-test-answer-3'), $('.alphabet-test-answer-4')];

  if (Math.random() > 0.5) {
    (function () {
      // Find character name by character
      var ci = charactersInfo[Math.floor(Math.random() * charactersInfo.length)];
      var char = ci.characterBegin;
      var imgName = ci.n;
      ...
      var answers = fillAnswers(answerButtons.length, ci);
...
//
$(function () {
  var $alphabetBody = $('.alphabet-table-body');

  charactersInfo.forEach(function (ci) {
    var $tr = $('<tr></tr>');
